...
- [ ] `TASK-012` — Multipista: varias líneas de medios (vídeo/imagen superpuestos, PiP)
  ...
  - **Pendiente**: Fase 4 (timeline multipista: carriles, añadir/quitar, arrastre entre pistas — ya existen las ops del store), Fase 5 (opacidad por capa en UI). Marcadores `TODO(fase2)` en `projectStore.ts` (ripple/split por pista). Cada fase tendrá su propio plan.
  - Priority: high
